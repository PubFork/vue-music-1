...
// stage content:
(lib.maze = function(mode,startPosition,loop, mazeConf) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	//this.shape.graphics.f("#EBCB35").s().p(encodePath);
	...
	//this.shape.setTransform(xOffset, yOffset, scaleX, scaleY, rotation);
