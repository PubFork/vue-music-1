...
(function(window){
	...
	displaylib.GameHUD = function(stage, img){ 
		...
		(displaylib.startButton = function(imgs) {
			...
			// var dataOnButton = {
			//      images: [imgs.start_btn_on_png, imgs.start_btn_off_png],
			//      frames: {width:170, height:128},
		...
		(displaylib.nextQuestionButton = function() {
			...
			//this.imageArrows = new displaylib.arrows();
			//this.imageArrows.sourceRect = new createjs.Rectangle(100,0,35,43);
			//this.addChild(this.imageArrows);
		...
		this.onResize = function(){
			...
			//console.log(stageWidth/2 - 100/2);
			//console.log(stageHeight/2 - 25/2);

			this.nextButton.x = stageWidth - 63;
			this.nextButton.y = stageHeight/2 - 128/2;
			//this.nextButton.scaleX = this.nextButton.scaleY = 2;
		...
		this.destroy = function(){
			console.log("destroy");
			/*
			stage.removeChild(this.startButton);
			stage.removeChild(this.nextButton);
			*/
		}
...
// 
	...
	(displaylib.MenuDisplay = function(stage, imgs) {
		...
		//this.questions_chap5 = new displaylib.questionsButton(imgs);
		//this.questions_chap5.x = 375;
		//this.questions_chap5.y = 460;
		...
		//var spriteSheetCloseButton = new createjs.SpriteSheet(dataCloseButton);
		...
		//this.addChild(this.questions_chap5);
		//this.addChild(this.questions_chap6);
