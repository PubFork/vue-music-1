var scale, scaleTrays, scaleReadings, scaleObjects, allObjects;
...
function scale_init() {
	...
	scale.regY = scale.image.height / 2;
    scaleBody = physics.makeRectangle(scale.image.width, 20, true, 1, 2, 2.7);
    ...
    trayWeldJoint1.localAnchorA = new b2Vec2(-0.5, -0.5);
    trayWeldJoint1.localAnchorB = new b2Vec2(-10, 0.5);
    ...
    trayWeldJoint2.bodyA = trayBody2;
    trayWeldJoint2.bodyB = scaleBody;
    //connect the centers - center in local coordinate - relative to body is 0,0
    trayWeldJoint2.localAnchorA = new b2Vec2(-0.5, -0.5);
    trayWeldJoint2.localAnchorB = new b2Vec2(10, 0.5);
    //joint_def.referenceAngle = 0 * Math.PI / 3;
    ...
    var objectImgs = quiz_content[qWord][2];
